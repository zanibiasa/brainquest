      ...
      <div id="settings-screen" class="screen">
        ...
        <div class="settings-card">
          ...
          <div class="settings-slider-row">
            ...
            <input type="range" id="settings-timer-slider" min="5" max="20" step="1" value="${state.timerDuration}">
        ...
        <div class="settings-card">
          ...
          <div class="settings-slider-row">
            ...
            <input type="range" id="settings-poll-slider" min="50" max="1000" step="50" value="${savedPoll}">
